  ...
  Sistem bize "Hangi boyutta olsun? (Büyük boy - orta boy - küçük boy olarak giriniz.) :   sorusunu sorsun. (büyük küçük harf duyarlılıgı olmamalı. yani kullanıcı büyük boy veya BüYüK Boy girdiginde kabul etmeli.  String boyut oluşturun...
       ...
       HERKESE KOLAY GELSİN !! (edited)
        ...
        switch (secim){
            ...
            case "1.":
            case"türk kahvesi":
                System.out.println("Türk Kahvesi'ni seçtiniz.");
                addMilk();
                addSugar();
                sizeOfCoffee();
                break;
            ...
            case "2.":
            case"filtre kahve":
                System.out.println("Filtre Kahve'yi seçtiniz.");
                addMilk();
                addSugar();
                sizeOfCoffee();
                break;
            ...
            case "3.":
            case"espresso":
                System.out.println("Espresso'yu seçtiniz.");
                addMilk();
                addSugar();
                sizeOfCoffee();
                break;
    ...
    public static void addMilk(){
        ...
        switch (addmilk){
            ...
            case "hayır":
                ...
                break;
            default:
                System.out.println("Lütfen sadece evet veya hayır yazınız...");
        }
    }
    ...
    public static void addSugar(){
        ...
        String addsugar = scan.next().toLowerCase();
        switch (addsugar){
            case "evet":
    ...
    public static void sizeOfCoffee(){
        Scanner scan = new Scanner(System.in);
        System.out.println("Hangi boyutta olsun? (Büyük boy - orta boy - küçük boy olarak giriniz.) : ");
        String size = scan.nextLine().toLowerCase();

        switch (size){
            case "büyük boy":
                System.out.println("Kahveniz büyük boy olarak hazırlanıyor...");
                break;
            case "orta boy":
                System.out.println("Kahveniz orta boy olarak hazırlanıyor...");
                break;
            case "küçük boy":
                System.out.println("Kahveniz küçük boy olarak hazırlanıyor...");
                break;
            default:
                System.out.println("Lütfen geçerli bir boyut giriniz.");
