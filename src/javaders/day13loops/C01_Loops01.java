...
public class C01_Loops01 {
    public static void main(String[] args) {
        ...
        int indexibulma =string.indexOf('a');
        System.out.println(string.substring(0,indexibulma));

        //bu benim çözümüm şimdi aşağıya hocanın çözümünü yazıcam.
