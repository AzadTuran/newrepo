...
public class Sets01 {
    ...
    2)3 tane Set Class vardir;
      i)HashSet Class:
              ...
              "HashSet"ler "null"i eleman olarak kabul eder.(Sadece 1 tane null koyabiliriz çünkü tekrarsı elemanlarla çalışır Set'ler.)
              "HashSet"ler tekrarsiz eleman depolamak içindir.
    ...
    public static void main(String[] args) {
        ...
        hs.add("Zeki");
        hs.add("Ezel");
        hs.add("Cuneyt");//Tekrarli eleman eklediğimizde hata vermez ama tekrarli elemani sadece bir kere ekler.

        System.out.println(hs);//[Zeki, Ajda, Cuneyt, Esra, Ezel]

        hs.add(null);
        System.out.println(hs);//[null, Zeki, Ajda, Cuneyt, Esra, Ezel] null en başta olur.
        ...
        //LinkedHAsgSet bizim verdiğimiz sıraya göre dizer ama hashset rastgele dizer bu yüzden daha hızlıdır.
