...
public class Lambda01 {
    ...
    //Example 1: Bir List'teki elemanlari console'a yazdiran methodu yaziniz.
    //1.WAY:
    ...
    public static void printElUniqueToUpperCaseSorted(List<String>myList){
        myList.
                stream().//lambda methodlarını kullanabilmek için
                distinct().//tekrarsız elemanlar için
                map(t->t.toUpperCase()).//değiştirmek için
                sorted().//alfabetik sıra
                forEach(t-> System.out.print(t+" "));//konsola yazdırmak için
    }
    ...
    public static void printElUniiqueLowerCaseSortWithLength(List<String>myList){
        ...
        myList.
                ...
                distinct().
                map(t->t.toLowerCase()).
                sorted(Comparator.comparing(t->t.length())).//kucukten buyuge dogru dizer.
                forEach(t-> System.out.print(t +" "));
